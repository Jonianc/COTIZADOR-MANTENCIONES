...
class ACPDF_PDF {
    ...
    public static function output_pdf($payload) {
        ...
        self::render_pdf($payload, $quote_no, 'attachment', true);
    }
    ...
    public static function output_pdf_from_log($entry) {
        ...
        self::render_pdf($payload, $quote_no, 'inline', false);
    }

    private static function render_pdf($payload, $quote_no, $disposition, $should_log) {
        $settings = ACPDF_Settings::get();
